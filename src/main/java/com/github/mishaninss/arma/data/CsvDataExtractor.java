...
public class CsvDataExtractor {
    ...
    public static void saveMapToCsvFile(String path, Map<String, List<String>> allLines, Charset charset) {
    ...
    public static void appendMapToCsvFile(String path, Map<String, List<String>> allLines, Charset charset) {
